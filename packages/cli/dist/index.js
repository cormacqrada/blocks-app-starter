...
program
    .name("blocks-app")
    .description("Blocks CLI for the Blocks ecosystem: Markdown as Data -> Executable Blocks -> Live Runtime -> Two-Way Serialization");
program
    .command("new")
    ...
    .action(async (category, template, name) => {

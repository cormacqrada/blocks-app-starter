...
hoistedDependencies:
  ...
  esprima@4.0.1:
    esprima: private
  examples/canvas-layout:
    canvas-node-app: private
  examples/collaborative-blocks-app:
    collaborative-blocks-app: private
  examples/dashboard-layout:
    dashboard-page-app: private
  examples/filesystem-markdown-watcher:
    filesystem-markdown-watcher: private
  examples/live-edit-blocks-dag:
    canvas-node-live-app: private
  examples/live-edit-blocks-design-tokens:
    design-system-playground-app: private
  examples/live-edit-blocks-inline:
    block-editor-app: private
  examples/markdown-to-blocktree:
    markdown-to-blocktree: private
  ...
  packages/cli:
    '@blocks-ecosystem/cli': private
  packages/config:
    '@blocks-ecosystem/config': private
  packages/core:
    '@blocks-ecosystem/core': private
  packages/registry:
    '@blocks-ecosystem/registry': private
  packages/renderer:
    '@blocks-ecosystem/renderer': private
  packages/runtime:
    '@blocks-ecosystem/runtime': private
  packages/types:
    '@blocks-ecosystem/types': private
  parent-module@1.0.1:
...
pendingBuilds:
  ...
  - .
  - .
prunedAt: Wed, 03 Dec 2025 05:52:59 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - turbo-windows-64@2.6.1
  - turbo-windows-arm64@2.6.1
storeDir: /Users/cormac/Library/pnpm/store/v3
